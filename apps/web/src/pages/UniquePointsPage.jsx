    ...
    >
      <Layout style={{ minHeight: "100vh", backgroundColor: palette.cream }}>
        ...
        >
          ...
          <Space size="large">
            <Button type="text" style={{ color: palette.darkOlive }}>
              Dashboard
            </Button>
            <Button type="text" style={{ color: palette.darkOlive }}>
              Timeline
        ...
        <Content
          style={{ padding: "80px 50px", backgroundColor: palette.cream }}
        >
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            >
              Why SafeThread is Different: Understanding Trauma-Informed Legal
              Documentation.
            </Title>
            ...
            <Row gutter={[32, 32]} style={{ marginBottom: "80px" }}>
              <Col xs={24} md={8}>
                ...
                >
                  <Title level={4} style={{ color: palette.darkOlive }}>
                    1. Non-Linear "Brain Dump"
                  </Title>
                  <Paragraph
                    style={{ color: palette.darkOlive, fontSize: "15px" }}
                  >
                    Recall fragments of memory as they surface, without the
                    pressure of sequential storytelling. Trauma-informed UI
                    reduces anxiety.
                  </Paragraph>
                </Card>
              </Col>
              <Col xs={24} md={8}>
                ...
                >
                  <Title level={4} style={{ color: palette.darkOlive }}>
                    2. Automatic Chronology
                  </Title>
                  <Paragraph
                    style={{ color: palette.darkOlive, fontSize: "15px" }}
                  >
                    Our logic automatically weaves your disjointed entries into
                    a seamless, legally structured timeline.
                  </Paragraph>
                </Card>
              </Col>
              <Col xs={24} md={8}>
                ...
                >
                  ...
                  <Paragraph
                    style={{ color: palette.darkOlive, fontSize: "15px" }}
                  >
                    Entries are hashed (SHA-256) and cannot be edited.
                    Corrections require new entries, mathematically proving
                    evidence integrity.
                  </Paragraph>
                </Card>
              </Col>
                    ...
                    cell: (props) => (
                      <th
                        ...
                        style={{
                          ...
                          color: palette.darkOlive,
                          fontWeight: "bold",
                          borderBottom: `2px solid ${palette.mutedGrey}`,
                        }}
                      />
                    ),
                  },
        ...
        <Footer
          style={{
            backgroundColor: palette.mutedGrey,
            padding: "60px 50px",
            color: palette.darkOlive,
          }}
        >
          <Row gutter={[48, 32]} maxWidth="1200px" style={{ margin: "0 auto" }}>
            <Col xs={24} md={8}>
              <Title
                level={4}
                style={{ color: palette.darkOlive, marginBottom: "16px" }}
              >
                SafeThread
              </Title>
            ...
            <Col xs={24} md={8}>
              <Space direction="vertical" size="small">
                <Space>
                  ...
                  <a
                    href="mailto:safethread143@outlook.com"
                    style={{
                      color: palette.darkOlive,
