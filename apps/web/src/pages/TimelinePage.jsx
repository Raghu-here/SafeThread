  ...
  return (
    <div className="relative pl-12 pb-16">
      ...
      <motion.div
        ...
        {audio && memory.attachments?.find(a => a.type === "audio") ? (
          <div className="bg-blush/20 rounded-3xl p-5 border border-silver-sage/30 space-y-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-forest font-sans">
                {memory.transcript || memory.attachments?.find(a => a.type === "audio")?.transcript || "No transcript available. Audio may still be processing or was not provided."}
              </p>
            </div>
            <audio
              src={memory.attachments.find(a => a.type === "audio")?.url}
              controls
...
export const TimelinePage = () => {
  ...
  const handleGenerateLegalDoc = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `safethread-legal-${Date.now()}.pdf`;
      a.click();
